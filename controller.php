...
END;
    ...
    if (isset($this->website->title) ){
      ...
      $part2 .='<h3>Next actions</h3>';
      $part2 .= "<div class=col-xs-2>Manage:</div> <div class=col-xs-10>"
        . " <a href=$wpath/advanced/$this->nid>status</a> | "
        ...
        . " or <a href=$wpath/create/$this->nid>create</a> "
        .  "</div>";
      
      $part2 .= "<div class=col-xs-2>Advanced:</div> <div class=col-xs-10>"
        . " <a href=$wpath/inspect/$this->nid>inspect</a> | "
        #. " <a href=/node/$this->nid/edit$des>Edit meta data</a> | "
        #. " <a href=$wpath/logs/$this->nid>logs</a> | "
        . " <a href=$wpath/rebuild/$this->nid onclick=\"return confirm('backup, stop, delete, and recreate " . $this->website->title . ". Data in the container will be lost! Are you sure you sure?')\">rebuild from sources</a> |"
        . " <a href=$wpath/rebuildmeta/$this->nid onclick=\"return confirm('Backup, stop, delete, and recreate from that same backup. i.e. to rebuild after changing an environment setting. Are you sure you sure?')\">rebuild from meta data</a> |"
        . " <a href=$wpath/cocmd/$this->nid>run command</a> | "
# NOT FINISHED        . " <a href=$wpath/couploadfile/$this->nid>file upload</a> |"
        . " <a href=$wpath/cocopyfile/$this->nid>folder download</a> "
        .  "</div>";

      $part2 .= "<div class=col-xs-2>Backup/restore:</div> <div class=col-xs-10>"
        . " <a href=$wpath/backup/$this->nid>backup container now</a> | "
        . " <a href=$wpath/backuplist/$this->nid>list backups</a> | "
        . " <a href=$wpath/coexport/$this->nid onclick=\"return confirm('Download this container to a tarfile? This will be slow as hundreds of MB are typical. ')\">download container</a> "
        .  "</div>";
      ...
      $part2 .='<div class=container-fluid>';
      $part2 .='<h3>Next actions</h3>';
      $part2 .= "<div class=col-xs-2></div><div class=col-xs-10> <a href=$wpath/advanced/$this->nid>back to container page</a>";
      $part2 .='</div>';
    }             
    ...
    if ( user_access('manage containers')) {
      ...
      $part2 .= "<div class=col-xs-2>Admin only:</div> <div class=col-xs-10>"
        . " <a href=$wpath/processes/$this->nid>container processes</a> | "
        . $tlink
        . " <a href=$wpath/kill/$this->nid>kill</a> | "
        . " <a href=$wpath/impull/$this->nid onclick=\"return confirm('Pulling the base image from Dockerhub will affect all future builds using that image. Are you sure you sure?')\">pull latest image</a> |"
        #. " <a href=$wpath/impull/$this->nid>pull latest image</a> | "
        . " <a href=$wpath/changes/$this->nid>filesystem changes</a> "
        .  "</div>";

    }
    $part2 .= "<div class=col-xs-2>Admin docker:</div> <div class=col-xs-10>"
        . " <a href=$wpath/version/$this->nid>docker version</a> |"
        ...
        .  "</div>";
    $part2 .= "<div class=col-xs-2>Admin nginx:</div> <div class=col-xs-10>"
        . " <a href=$wpath/proxyrestart/0$this->des onclick=\"return confirm('Restarting nginx will break the session, refresh the page manually after a few secs. ')\">restart nginx</a> |"
        . " <a href=$wpath/proxylogs/0$this->des>nginx logs</a> |"
        . " <a href=$wpath/proxy2restart/0$this->des>restart nginx-gen</a> |"
        . " <a href=$wpath/proxy2logs/0$this->des>nginx-gen logs</a> "
        .  "</div>";
    $part2 .= "</div>";
